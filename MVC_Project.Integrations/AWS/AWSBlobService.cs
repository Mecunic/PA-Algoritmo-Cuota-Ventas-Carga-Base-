...
namespace MVC_Project.Integrations.AWS
{
    public class AWSBlobService
    {

        public async static void UploadPublicFile(System.IO.Stream fileStream, string fileName, string containerName, string folder = "")
        {
            try
            {
