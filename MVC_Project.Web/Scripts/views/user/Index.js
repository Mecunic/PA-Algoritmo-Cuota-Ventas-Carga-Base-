    ...
    this.init = function () {
        ...
        $(self.htmlTable, "tbody").on('click',
            ...
            function () {
                ...
                //var tr = $(this).closest('tr');
                //var row = self.dataTable.row(tr);
                //console.log(row, row.data().PersonalId)
                //self._modal.find('.modal-content').load(modalEditAction + "?personalId=" + row.data().PersonalId,
                //    function (response, status, xhr) {
                //        //console.log(response, status, xhr)
                //        self._modal.modal('show');
                //        loading.stop();
                //        utils.actualizarValidaciones($('#edit-personal-form'));
                //        $("#btn-action-edit").on("click",
                //            function () {
                //                var validate = $('#edit-personal-form').validate();
                //                if (!$('#edit-personal-form').valid()) {
                //                    return;
                //                }

                //                var formData = $('#edit-personal-form').serializeFormJSON();

                //                console.log(formData)
                //                loading.start();
                //                $.ajax({
                //                    type: "POST",
                //                    url: $('#edit-personal-form').attr('action') + '/' + formData['PersonalId'],
